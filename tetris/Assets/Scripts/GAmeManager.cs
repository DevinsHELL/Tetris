...
public class GameManager : MonoBehaviour
{
    ...
    {
        int blocksize = 4;
        if (CurrentTEt.tag == "Tx")
        {
            blocksize = 5;
            //gameObject.AddComponent<SpriteRenderer>();
            //SpriteRenderer sr = GameObject.FindGameObjectWithTag("Tx").GetComponent<SpriteRenderer>();
        ...
        Debug.Log($"CurrentTEt '{CurrentTEt.name}' has {CurrentTEt.transform.childCount} children.");
